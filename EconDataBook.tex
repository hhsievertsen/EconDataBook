...
Please let me know if you find mistakes, find a section unclear, have suggestions for improvements, or if you have request for further topics to include. You can contact me on \href{mailto:h.h.sievertsen@bristol.ac.uk}{\nolinkurl{h.h.sievertsen@bristol.ac.uk}}.

Thanks,
Hans
Last updated on Tuesday, September 20, 2022
...
\item
  \textbf{Where does the data come from?} We know that the data source for Figure \ref{fig:fig1} is the Maddison Project Database (MPD) 2018, but where do they get the from? How can we download the data to create our own chart? We will cover data basics in part II.
\item
...
\caption{\label{tab:tab1}GDP per capita in the United Kingdom. This chart does a poor job in communicating the data. Source: Maddison Project Database (MPD) 2018.}
\centering
\begin{tabular}[t]{l}
\hline
![](/resources/chapter\_introduction/table1.png)\\
\hline
\end{tabular}
\end{table}
