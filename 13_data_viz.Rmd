...
```{r viz3, echo=FALSE, out.width = '50%',fig.show='hold',fig.align='center',fig.cap="scatterplots of Anscombe's quartet. The dashed line is fitted using Ordinary Least Squares. Upper left: Dataset 1. Upper right: Dataset 2. Lower left: Dataset 3. Lower right: Dataset 4."}
...
```{r viz5, echo=FALSE, out.width = '30%',fig.show='hold',fig.align='center',fig.cap="A table with a categorical variable in rows and a numerical variable in columns"}
...
```{r viz6, echo=FALSE, out.width = '60%',fig.show='hold',fig.align='center',fig.cap="A table with one numerical variable and two categorical variables"}
...
```{r viz7, echo=FALSE, out.width = '70%',fig.show='hold',fig.align='center',fig.cap="A table with a hierarchical structure."}
...
```{r viz8, echo=FALSE, out.width = '48%',fig.show='hold',fig.align='center',fig.cap="A poorly designed and structured table and a table with a good structure and layout."}
